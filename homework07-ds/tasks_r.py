...
Original file is located at
    https://colab.research.google.com/drive/1CfMuD3hxBQkI-dyEX_Tolco8hhkH-s0F
"""

df1 <- read.csv("adult1.csv")
head(df1)
...
mean(df1$age[df1$salary == " >50K"])
sd(df1$age[df1$salary == " >50K"])
mean(df1$age[df1$salary == " <=50K"])
sd(df1$age[df1$salary == " <=50K"])
